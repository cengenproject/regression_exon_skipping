...
#~ Load data ----
quantifs_filtered <- qs::qread(file.path(datadir, "240429_preprocessed_quantifs_filtered.qs"))
sf_expression <- qs::qread(file.path(datadir, "240429_preprocessed_sf_expression.qs")) |>
...
save_dir <- "data/graph_power4/inputs/240429_precomputed/"
